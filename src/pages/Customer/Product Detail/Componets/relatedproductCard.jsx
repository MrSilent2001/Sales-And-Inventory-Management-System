...
export default function MediaControlCard({ item, handleBodyClick }) {
    ...
    return (
        <Card sx={{ display: 'flex', flexDirection: 'column', height: 120, minHeight: 120 ,width: 400, marginTop: 4, marginLeft: 4, backgroundColor: 'whitesmoke' }} onClick={() => handleBodyClick(item)}>
