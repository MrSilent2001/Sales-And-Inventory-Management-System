...
//                                 <span className='text-g priceLarge'>Rs {product.productPrice}</span>
//                                 <div className='ml-3 d-flex flex-column'>
//                                     <span className='text-org'>{product.discount}% Off</span>
//                                     {/*<span className='text-light oldPrice'>Rs {product.oldPrice}</span>*/}
//                                     <span className='text-light oldPrice'>Rs 100</span>
//                                 </div>
//                             </div>
//
...
//
//                             {
//                                 product.weight !== undefined && currentProduct.weight.length !== 0 &&
...
//
//                             {
//                                 product.RAM !== undefined && product.RAM.length !== 0 &&
//                                 <div className='productSize d-flex align-items-center'>
//                                     <span>RAM:</span>
//                                     <ul className='list list-inline mb-0 pl-4'>
//                                         {
...
//                                     {/*        onClick={() => addToCart(currentProduct)}><ShoppingCartOutlinedIcon/>*/}
//                                     {/*        {*/}
...
//                                     {/*}*/}
//                                     {/*<Button*/}
//                                     {/*    className=' btn-lg addtocartbtn  ml-3  wishlist btn-border'><FavoriteBorderOutlinedIcon/>*/}
//                                     {/*</Button>*/}
//                                     {/*<Button*/}
//                                     {/*    className=' btn-lg addtocartbtn ml-3 btn-border'><CompareArrowsIcon/></Button>*/}
//
//                                 </div>
//
//
...
//                                                                 </div>
//                                                                 <span
//                                                                     className='text-g d-block text-center font-weight-bold'>{item.userName}</span>
//                                                             </div>
//
//
...
//                                                               name="review" value={reviewFields.review}
//                                                               onChange={(e) => changeInput(e.target.name, e.target.value)}></textarea>
//                                                 </div>
//
//                                                 <div className='row'>
//                                                     <div className='col-md-6'>
//                                                         <div className='form-group'>
//                                                             <input type='text' value={reviewFields.userName}
