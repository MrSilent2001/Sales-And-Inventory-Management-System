...
const rows = [
    createData('0001', 'Finn Allen', 'No.65, Yorkshire, England', <SendWarningButtons onClick={handleButtonClick}>Send Warning</SendWarningButtons>, <RemoveButtons onClick={()=>{alert("Customer Has been Removed")}}>Remove</RemoveButtons>),
